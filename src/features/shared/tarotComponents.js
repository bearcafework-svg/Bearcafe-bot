        ...
        components: [
          { type: 14, spacing: 2, divider: false },
          {
            ...
            content:
              ...
              `-# <a:3602exclamationmarkbubble:1372837492205555812>⠀**คำอธิบายระบบเจ้าผึ้ง** : ไม่รู้เหมือนกัน เดี๋ยวให้เจ้าผึ้งลองอธิบายดูนะ\n` +
              ` > (<:cuteplant:1152834055528783872>)⠀**__\`เจ้าผึ้ง\`__** : หวี่ หวี วิ๊ หวี่หวี่ วิ๊ หวี หวึ่ง วิ๊ หวี หวี่ วิ๊ หวี หวี่หวี่ วิ๊ หวึ่ง หวี วิ๊ หวี่ วิ๊ หวี หวี่ หวี่ วิ๊ หวึ่ง หวี วิ๊ หวี่ หวี วิ๊ หวี่ หวึ่ง วิ๊ หวี หวี่ วิ๊`
          },
          { type: 14, spacing: 2, divider: false }
        ]
      }
