-- =========================================================================
-- 1. SQL สำหรับเซ็ตค่า notes ของทีมงานทุกรายการเป็นข้อความต้อนรับเริ่มต้น
-- =========================================================================
UPDATE public.staff_members
SET notes = 'ยินดีต้อนรับนะ ขอให้เธอได้เจอเพื่อนดี ๆ มีความสุข สนุกกับทุกช่วงเวลา และสมหวังในทุกสิ่งที่ตั้งใจ <a:bearg23:1396016002818506754>';
