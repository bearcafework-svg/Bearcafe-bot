...
module.exports = [
  ...
  },
  {
    ...
    category: "VOICE",
    title: "คุยกับเพื่อน",
    description: "อยู่ในห้องเสียงพร้อมสมาชิกคนอื่นอย่างน้อย 20 นาที",
    targetCount: 20,
    unit: "นาที",
    rewardPoints: 20,
    difficulty: "NORMAL",
  ...
  },
  {
    ...
    category: "VOICE",
    title: "ผีประจำคาเฟ่",
    description: "สิงอยู่ในห้องเสียงรวดเดียวต่อเนื่องครบ 45 นาที",
    targetCount: 45,
    unit: "นาที",
    rewardPoints: 25,
    difficulty: "HARD",
  ...
  // 🎮 หมวด 3 — Minigame Quest (6 ภารกิจ)
  {
    ...
    category: "MINIGAME",
    title: "เซียนมินิเกม",
    description: "ร่วมสนุกเล่นมินิเกมและชนะสะสม",
    targetCount: 5,
    unit: "ชนะ",
    rewardPoints: 15,
    difficulty: "EASY",
  ...
  },
  {
    ...
    category: "MINIGAME",
    title: "นักเสี่ยงดวง",
    description: "ร่วมสนุกตอบคำถามมินิเกมห้องใดก็ได้ครบ 8 รอบ",
    targetCount: 8,
    unit: "รอบ",
    rewardPoints: 15,
    difficulty: "EASY",
  ...
  // 🌱 หมวด 4 — Bear Cafe Feature Quest (6 ภารกิจ)
  {
    ...
    category: "FEATURE",
    title: "เติมพลังใจ",
    description: "พิมพ์ข้อความ \"ขอกำลังใจ\" ในห้องฮีลใจ",
    targetCount: 1,
    unit: "ครั้ง",
    rewardPoints: 15,
    difficulty: "EASY",
  ...
  // 🎮 หมวดพิเศษ — Game Quest (เล่นเกมใดก็ได้ 30 นาที)
  {
    id: "GAME-01",
    category: "GAME",
    title: "พักผ่อนในโลกเกม",
    description: "เปิดเล่นเกมโปรดใดก็ได้ (เช่น Roblox, Genshin, Minecraft)",
    targetCount: 30,
    unit: "นาที",
    rewardPoints: 20,
    difficulty: "NORMAL",
    trackerType: "GAME_MINUTES"
  }
];
