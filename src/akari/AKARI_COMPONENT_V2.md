...
### 🔒 แม่แบบที่ 11: หน้าต่างเลือกช่องของรางวัลเพื่อสลับการจำกัดสิทธิ์ (`Store Limit - Slot Select`)
> เหมาะสำหรับ: หน้าต่าง Ephemeral เมื่อกดปุ่ม "จำกัด 1 ครั้ง/คน" เพื่อให้แอดมินเลือกช่องของรางวัล Custom ที่จะสลับระหว่าง จำกัด 1 ครั้ง/คน กับ แลกได้ไม่จำกัด

```javascript
const limitSlotSelectPayload = {
  flags: 32768,
  components: [
    {
      type: 17,
      components: [
        {
          type: 10,
          content:
            "## 🔒︲__` 𝖲𝗍𝗈𝗋𝖾 𝗅𝗂𝗆𝗂𝗍 ₊ เลือกช่องที่ต้องการสลับการจำกัดสิทธิ์ 𓂃 `__\n" +
          ...
          components: [
            {
              ...
              custom_id: "akari_store_limit_slot_target",
              placeholder: "🔒︲เลือกช่องของรางวัลที่ต้องการสลับการจำกัดสิทธิ์...",
              options: [
                { label: "รางวัล 1: ของขวัญ", value: "1" },
                { label: "รางวัล 2: โค้ดเกม", value: "2" },
                { label: "รางวัล 3: สิทธิ์พิเศษ", value: "3" },
              ],
            },
          ],
        },
